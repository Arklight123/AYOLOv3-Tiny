...
def train():
    ...
    # Image Sizes
    gs = 32  # (pixels) grid size,   64 before
    ...
    lf = lambda x: (((1 + math.cos(x * math.pi / epochs)) / 2) ** 1.0) * 0.99 + 0.01  # cosine
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        print('\n' + 'Using learning rate: %g' % (optimizer.param_groups[0]['lr']))
        model.train()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-tiny-changeV6-dila-normal2-3.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='data/PAD.data', help='*.data path')
