...
def get_feature():
    ...
    parser.add_argument('--cfg', type=str, default='cfg/my_moduleV4.cfg', help='*.cfg path')
    ...
    pic_dir = './images/test.jpg'
    transform = transforms.ToTensor()
    img = get_picture(pic_dir, transform)
    # device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    device = torch_utils.select_device('0', apex=True, batch_size=4)
    ...
    # net.load_state_dict(torch.load('./weights/best.pt'))
